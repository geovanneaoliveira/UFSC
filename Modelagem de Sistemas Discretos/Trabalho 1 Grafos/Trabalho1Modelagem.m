...
figure('Name','G1');
plot(G1,'XData',(XY_Points(:,1))','YData',(XY_Points(:,2))','NodeFontSize',20,'NodeColor','k','EdgeColor','b','LineWidth',3,'Marker','o','MarkerSize',10);
P1 = plot(G1,'EdgeLabel', G1.Edges.Weight);
[Cost, Route] = Dijkstras(G1,1,4);
%[dist,path] = dijkstra(G1,1,4);
