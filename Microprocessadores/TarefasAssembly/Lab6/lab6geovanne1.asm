...
todo_3:
    ...
    # Get value of the memory mapped receiver control register (0xffff0000).
    #lw $s0, 0x??
...
KEYBOARD_INTERRUPT: 	.asciiz "===>      Keyboard interrupt       <===\n\n"
...
todo_2:	
	...
	#beq $k1, ?, __bad_address_exception
	
	# TODO: Add code to branch to label __trap_exception for exception code 13 from $k1 register. 
	#beq $??, 13, __trap_exception
...
todo_4:
  	# TODO: Use the MARS built-in system call service 4 (print string) in $v0 register to print error messsage.
	#li $??, ?
        # TODO: load in $a0 register the memory address (la instuction) for the label of the KEYBOAR_INTERRUPT message
	#la $??,  KEYBOARD_INTERRUPT
	syscall
 
	# TODO: Store content of the memory mapped receiver data register (oxfff0004) in $k1.
	#lw $k1, 0x? 

	# Use the MARS built-in system call 11 (print char) to print the character
	# TODO: from receiver data.
