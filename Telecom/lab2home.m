...
M = 4; % Ordem da modulação (Ex: 4 para QPSK)
k = log2(M); % Bits por símbolo
numBits = 5e5; % Número de bits (alto para capturar erros em SNR alta)
EbNo_dB = 0:2:12; % Vetor de valores de Eb/No em dB para a varredura
...
hold on;
semilogy(EbNo_dB, BER_sim, 'ro', 'MarkerSize', 8, 'LineWidth', 1.5); % Círculos vermelhos para
o Simulado
