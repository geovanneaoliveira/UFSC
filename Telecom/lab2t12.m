...
BER_teo_psk = berawgn(EbNo_dB, 'psk', M, 'nondiff'); 
BER_teo_qam = berawgn(EbNo_dB, 'qam', 16, 'nondiff'); 


% 4. Plotagem em Cascata (Waterfall Curve) 
figure('Name', 'Desempenho BER', 'NumberTitle', 'off'); 
semilogy(EbNo_dB, BER_teo_psk, 'b', 'LineWidth', 2); % Linha contínua azul para o Teórico 
hold on; 
semilogy(EbNo_dB, BER_teo_qam, 'y--', 'LineWidth', 2); % Linha contínua azul para o Teórico 
